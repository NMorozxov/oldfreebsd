...
print_hdr("IP Statistics",$user_ip,$d_mon,$d_year);
...
// echo "<tr><td><center>Date</center></td><td align=right>",$row->DATE_MONTH,"/",$row->DATE_YEAR,"</td></tr>";
 echo "<tr><td><center>Traffic Limit</center></td><td align=right>",$row->LIMIT,"</td></tr>";
 echo "<tr><td><center>Used traffic</center></td><td align=right>",$row->SUM_TRAF,"</td></tr>";
 echo "<tr><td><center>Outgoing traffic</center></td><td align=right>",$row->SUM_TRAF_OUT,"</td></tr>";
 echo "<tr><td><center>Name</center></td><td align=right>",$row->LNAME,"</td></tr>";
 echo "<tr><td><center>PC Name</center></td><td align=right>",$row->PCNAME,"</td></tr>";
