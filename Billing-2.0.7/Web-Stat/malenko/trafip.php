...
$title=sprintf("Трафик для каждого компьютера за %s/%s",$d_mon,$d_year);
print_base_hdr($title);
//echo '<tr><td><center><b>Date</b></center></td><td align=right><b>',$d_mon,'/',$d_year,'</b></td></tr>';

echo "<tr><td valign=top align=center><b>#</b></td><td valign=top align=center><b>IP-адрес<br>компьютера</b></td><td align=center><b>Имя<br>компьютера</b></td><td align=center><b>Входящий<br>трафик, байт</b></td><td align=center><b>Исходящий<br>трафик, байт</b></td></tr>";
